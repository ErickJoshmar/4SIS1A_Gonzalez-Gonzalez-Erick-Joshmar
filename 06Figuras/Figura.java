...
public class Figura {
        ...
        switch(opcion){
            ...
            case 2:
                ...
                if(lado == lado2 && lado == lado3 && lado2 == lado3){
                    System.out.println(" Con los datos ingresados el tipo de triangulo es : Equilatero ");
                }
                if(lado != lado2 && lado2 == lado3 && lado != lado3){
                    System.out.println("Con los datos ingresados el tipo de triangulo es : Isoseles "); 
                }
                if(lado != lado2 && lado != lado3 && lado2 != lado3){
                    System.out.println("Con los datos ingresados el tipo de triangulo es : Escaleno "); 
                }
                break;
            default:
    ...
    public void calcularRectangulo(){
        System.out.println("Ingrese 1. Para Area");
        System.out.println("Ingrese 2. Para Perimetro");
