...
class Ejercicios {
    ...
    /**
     * Vamos a hacer una calculadora, un conversor de unicsdes creación de cuadros y
     * de movimiento
     */

    // Los métodos son las operaciones de un objeto o de una clase, también llamado
    // comportamiento
            ...
            case 'c':
                ...
                while (comprobacion) {
                    try {
                        ...
                        System.out.println("Son solo valores numericos");
    ...
    public void Ejercicio2() {
         ...
         */
        double metros = 0.00, kg = 0.00, milla = 0.000621371, cm = 100.00, pulgada = 39.37, gramos = 1000.00,
                libra = 2.20, ms = 0.00, yarda = 1.09361;
        double a, b;
    ...
    public void Ejercicio3() {
        ...
        /*
         * Deben de ingresar un numero de * / para que se arme un cadrado por ejemplo de
         * poder aceptar del 1 al 1000
         * ***********
         * ///////////
         ***********
         * ///////////
...
double ladocua;
        ...
        while (comprobacion) {
            try {
                ...
                ladocua = entrada.nextInt();
                if (ladocua >= 1 & ladocua <= 1000) {
                    for (int i = 0; i < ladocua; i++) {
                        for (int j = 0; j < ladocua; j++) {
                            System.out.print("* ");
