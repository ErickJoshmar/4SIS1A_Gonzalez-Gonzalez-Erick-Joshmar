...
class EstructuraDatos {
    ...
    public static void main(String[] args) {
        try (// objetos
            ...
            int opcion, numbinario, edad, opcion1, cneg = 0, cpos = 0, cneutro = 0, desc = 0, numeroF = 0, facto = 1,
                    ladocuadra = 0, ladohue = 0, ladoo;
            char letra, artic;
            String binario = "";
            double farenheit, centigrados, grados, u = 0, Rankine, kelvin;
                    ...
                    case 3:
                        ...
                        switch (opcion1) {
                            case 1:
                                ...
                                System.out.println(
                                        "La conversion de los grados ingresados a Farenheit es: " + farenheit + " °F");
                                break;
                            case 2:
                                System.out.println("Ingrese los grados");
                                grados = entrada.nextFloat();
                                centigrados = (grados - 32) * 5 / 9;
                                System.out.println("La conversion de los grados ingresados a Centigrados es: "
                                        + centigrados + " °C");
                                break;
                            case 3:
                                System.out.println("Ingrese los grados");
